...
<template>
  <section class="">
    <div class="grid grid-cols-1 lg:grid-cols-3 mx-20" id="ser-feito">
      <div  class="centralizarImagem my-20 ">
        <video width="1000"    controls class="h-full">
          <source src="../../assets/mp4/ApraxKidsTreinamentos.mp4" type="video/mp4" />
        </video>
      </div>
      <div class="lg:col-span-2">
        <div
          class="bg-cover bg-center 2xl:w-1/2 2xl:m-auto h-auto  py-24 px-10 object-fill bg-image "
        >
          <div class="text-center lg:text-left">
            <p class="font-bold text-sm uppercase text-blue-nuvem">Mas como o treinamento irá</p>
            <p class="text-7xl font-bold mb-8">
              <span class="normal-case underline text-green">Ser Feito<span class="animate-pulse">?</span> </span>
            </p>
