        ...
        <nav class="px-0 lg:px-6 pt-2.5 lg:pt-auto lg:py-2.5">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2 lg:hidden">
                    <button data-collapse-toggle="mobile-menu-2" type="button" class="mx-4 mb-2.5 lg:mb-0 transition duration-300 inline-flex items-center p-2 ml-1 text-sm text-white rounded-lg lg:hidden bg-header focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <router-link to="/" class="estilo-menu" aria-current="page">Home</router-link>
                        </li>
                        <li>
                            <router-link to="/about" class="estilo-menu">Company</router-link>
                        </li>
                        <li>
                            <router-link to="/about" class="estilo-menu">Marketplace</router-link>
                        </li>
                        <li>
                            <router-link to="/about" class="estilo-menu">Features</router-link>
                        </li>
                        <li>
                            <router-link to="/about" class="estilo-menu">Team</router-link>
                        </li>
                        <li>
                            <router-link to="/about" class="estilo-menu">Contact</router-link>
                        </li>
                    </ul>
                </div>
            </div>
